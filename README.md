...
* Файлах app.yml и db.yml переписаны под использование ролей
* Создана директория environments для определения настроек окружения
* Копия файла ansible/inventory перенесен в директории ansible/environments/prod и ansible/environments/stage. Исходный файл при этом удален
...
* Созданы групповые переменные для групп хостов app, db и all в окркужениях stage и prod
...
* Установлена роль jdauphant.nginx. Теперь puma доступен по порту 80
* Создан файл с паролем ~/.ansible/vault.key
